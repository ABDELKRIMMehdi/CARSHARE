    ...
    <div class="page MyAccount-page">
      <div class="page-contents">
        ...
        <div>
          ...
          <div >Date Of Birth : <?php  echo "<p  style='display: inline; font-weight: 600; margin-left: 60px'>" . $_SESSION["birthday"] . "</p>" ?> </div>
          <div >Gender : <?php  echo "<p  style='display: inline; font-weight: 600; margin-left: 135px'>" . $_SESSION["gender"] . "</p>"?></div>
          <div>E-mail : <?php  echo "<p  style='display: inline; font-weight: 600; margin-left: 50px'>" . $_SESSION["email"] . "</p>"?></div>
          <div>tel : <?php  echo "<p  style='display: inline; font-weight: 600; margin-left: 100px'>" . $_SESSION["tel"] . "</p>" ?></div>
    ...
    <div>
        ...
        <label for='FirstName' class='form__label'>FirstName : </label>
                ...
                <div id = 'PN'>
                    ...
                    <input type='tel' name='full_phone' id='phone' value='" . $_SESSION["tel"] . "' onchange='this.setAttribute('value', this.getValue());'/>
                </div>
